...
function startLoader() {
  let textElement = document.querySelector(".text__letters");
...
function hideLoader() {
  gsap.to(".loader__text", { duration: 0.8, ease: 'power2.in', y: "100%", delay: 1.8 });
...
splitTypes.forEach((char,i) => {
  try {
    ...
    if (text && text.chars && text.chars.length > 0) {
    ...
    console.warn("SplitType error for element:", char, e);
  }
});
